...
<html>
	<head>
		...
		<title>Watch_Dog | Track Vote Status</title>
											...
											<div class="box box-success">
												...
												<div class="box-body">
													<div class="progress-group">
														<span class="progress-text">ยอดผู้ร่วมโหวต</span>
...
function get_table_data()
{
	...
	.done(function(data) {
		...
		jQuery.each( data_arr, function( i, val ) {
			...
			{
				print_text +="<TD><font color='#ff8080'><B>ยังไม่ได้โหวต</B></font></TD>";
				print_text +="<TD></TD>";
			}
			else
			{
				Check_in_CNT = Check_in_CNT + 1;
				print_text +="<TD><font color='#00cc00'><B>โหวตแล้ว</B></font></TD>";
