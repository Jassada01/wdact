				...
				<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
					...
					<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form">
						...
						<div class="text-center mb-10">
							<!--begin::Title-->
							<h1 class="text-dark mb-3">แจ้งรหัสชั่วคราวผ่านทาง Email</h1>
							<!--end::Title-->
							<!--begin::Link-->
						...
						<div class="d-flex flex-wrap justify-content-center pb-lg-0">
							<button type="button" id="btn_start_access" class="btn btn-lg btn-primary fw-bolder me-4 my-1" style="display: none;">
								<span>เข้าสู่ระบบ</span>
							</button>
							<span>

								<button type="button" id="btn_reset_passcode" class="btn btn-lg btn-light-danger fw-bolder me-2 my-1" >
