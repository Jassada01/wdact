					...
					<div class="row">
						<div class="col-lg-3 col-xs-6">
							...
							<div class="small-box bg-aqua">
								<div class="inner">
									<h3 id="like_cnt_data"></h3>
									<p><span id="like_to_target"></span> to target</p>
								</div>
								<div class="icon">
						...
						<div class="col-lg-3 col-xs-6">
							...
							<div class="small-box bg-green">
								<div class="inner">
									<h3><span  id="pub_post_cnt"></span><sup style="font-size: 14px"> เรื่องลงเพจ</sup></h3>
									<p><span id="pub_post_pct"></span> % จากเป้าหมาย</p>
								</div>
								<div class="icon">
						...
						<div class="col-lg-3 col-xs-6">
							...
							<div class="small-box bg-red">
								<div class="inner">
									<h3><span id="dmg_yr_data">154</span><sup style="font-size: 14px"> ล้านบาท</sup></h3>
...
function load_static_like_data()
{
	...
	.done(function(data) {
		...
		//alert(ojb.like_cnt)
		$('#like_cnt_data').html(ojb.like_cnt);
